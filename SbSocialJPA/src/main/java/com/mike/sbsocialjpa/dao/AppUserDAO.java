...
import com.mike.sbsocialjpa.formvalidator.AppUserForm;
import com.mike.sbsocialjpa.utils.EncryptedPasswordUtils;
...
public class AppUserDAO {
	...
	public AppUser findByEmail(String email) {
		try {
			String sql = "Select e from " + AppUser.class.getName() + " e " //
					+ "Where e.email = :email";
			Query query = entityManager.createNamedQuery(sql, AppUser.class);
	...
	public AppUser createAppUser(Connection<?> connection) {
		...
		String encryptedPassword = EncryptedPasswordUtils.encryptePassword(randomPassword);
		// 
		appUser = new AppUser();
	...
	public AppUser registerNewUsesrAccount(AppUserForm appUserForm, List<String> roleNames) {
		...
		this.appRoleDAO.createRole(appUser, roleNames);
